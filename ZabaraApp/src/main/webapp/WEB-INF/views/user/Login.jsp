									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group" id="secondLogin" style="display:none;">
												<div class="form-group">
														<input type="email" name="searchid" class="form-style" placeholder="Your Email" id="searchid" autocomplete="off">
														<i class="input-icon uil uil-at"></i>
														<div>&nbsp</div>
												</div>
											</div>
											<a href="#" id="sendPassword" class="btn mt-4" style="display:none;">Send Password</a>
											<a href="#" id="backToLogin" class="btn mt-4" style="display:none;">Cancel</a>
									</div>
								</div>
							</div>
								<div class="card-back">
...
$('#nextBtn').click(function (e) {
	...
	case 2:
		...
		if(emailcheck==1 && form.email.value.trim()!=inputemail){
			addMessage('인증이 완료된 후 이메일을 변경하실 수 없습니다.',form.email);
			form.email.focus();
			$('#emailtimer').hide();
			$('#emailCheckBtn').show();
			if (e != undefined)
