	        	...
	        	<div class="col-lg-8 pb-3">
	          	...
	          	<div class="col-lg-4 custom-form " style="margin-bottom: 15px;">
	            	<div class="content">
						...
						<div class="my-3">
							<p>가격</p>
							<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" placeholder="가격을 입력하세요" name="price" pattern="[1-9][0-9]{0,10}0" title="금액은 0으로 시작할 수 없습니다. / 금액은 0으로 끝나야합니다." required="required">
						</div>
						<div class="mt-3 mb-5">
							<p>내용</p>
...
$('#goList').on("click", function(){
	 window.location.href = "<c:url value='/board/productlist.do'/>";
});
