...
<div class="container mt-5" >
	<div class="mt-5" >
		<div class="container">
			<div class="section-title" style="text-align: left;">
	         	<img src="${pageContext.request.contextPath}/resources/assets/img/title_weather.png" style="width: 200px" />
	        </div>
	...
	<div class="container mt-3" >
		<div class="section-title" style="text-align: left;">
         <img src="${pageContext.request.contextPath}/resources/assets/img/title_news.png" style="width: 200px" />
        </div>		
		   <table class="big">
		      <tr class="title">
