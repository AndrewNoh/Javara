    ...
    <div class="container">
     ...
     <div class="card">
       ...
       <div id="collapseTwo" class="collapse" data-parent="#accordion">
         <div class="card-body">
           자바라는 동네 이웃 간의 연결을 도와 따뜻하고 활발한 교류가 있는 지역 사회를 만들기 위해 노력하고 있어요.
         이웃을 향한 당신의 따뜻한 관심과 애정은 자바라의 가장 큰 동력이에요. 자바라를 사용하는 이웃 모두가 커뮤니티 가이드라인을 지키며 따뜻한 지역 커뮤니티를 함께 만들어요. 혼자 힘으로는 할 수 없지만, 우리가 함께라면 할 수 있어요!
         자바라는 신뢰, 존중, 윤리를 서비스의 중요한 가치라고 생각해요. 우리는 이 가치를 지키기 위해 언제나 최선을 다할 거예요. 더 가깝고 따뜻한 지역 커뮤니티를 위해 동참해주세요.
            </br>
     ...
     <div class="card">
       ...
       <div id="collapseThree" class="collapse" data-parent="#accordion">
         <div class="card-body">                   
           자바라는 동네 이웃 간의 연결을 도와 따뜻하고 활발한 교류가 있는 지역 사회를 만들기 위해 노력하고 있어요.
         우리는 신뢰, 존중, 윤리를 서비스의 중요한 가치라고 생각해요. 자바라를 사용하는 이웃 모두가 동참하여 이 가치를 지키기 위해 최선을 다하고 있어요. 따뜻하고 믿을 수 있는 거래 문화를 함께 만들어가요.   
     ...
     <div class="card">
       ...
       <div id=collapseNine class="collapse" data-parent="#accordion">
         <div class="card-body">
           <p>자바라는 좋은 물건을 '잘 잡아라'라는 뜻이 있는 고유 명칭입니다.</p>
           ...
           <p>그럼 저희 자바라 서비스를 이용할 준비 되셨나요?</p>           
         </div>
       </div>
     </div>
     ...
     <div class="card">
       ...
       <div id=collapseThirteen class="collapse" data-parent="#accordion">
         <div class="card-body">
           <p>모든 히스토리는 [나의 자바라] → [게시글 확인] 에 저장하고 있어요. 게시글이 노출되는 동네는 물론, 기간이나 예산까지 확인할 수 있어요.</p>
         </div>
       </div>
     </div>
     ...
     <div class="card">
       ...
       <div id=collapseForeteen class="collapse" data-parent="#accordion">
         <div class="card-body">
           <strong>[자바라 게시글 공통 제한사항 안내]</strong>
         ...
         <p>8) 자바라 서비스로 오인될 우려가 있는 광고</p>
         <ul>
         <li>자바라의 로고, 상표, 서비스명, 저작물 등을 무단으로 사용한 경우</li>
         <li>자바라 서비스로 오인될 여지가 있는 내용</li>
         </ul>
         </div>
       </div>
     </div>
     ...
     <div class="card">
       ...
       <div id=collapseFifthteen class="collapse" data-parent="#accordion">
         <div class="card-body">
           <strong>삭제를 포함한 게시글 관리는 [나의 자바라] → [게시글 확인] 에서 진행할 수 있어요.</strong>
