...
<div style="position: fixed;bottom: 110px; right: 30px;">
  ...
  <div id="board" class="container mt-5">
      ...
      <div class="section-title">
        ...
        <h1 style="font-size: 18px">동네생활은 이웃과 함께 정보를 공유하고, 이야기를 나누는 공간이에요.

      이웃에게 물어보면, 이웃들이 친절하게 진짜 정보를 알려줄거에요.<br/>

      나만 알고 있던 동네 가게를 이웃과 공유해보세요.

      동네에서 무언가를 잃어버렸다면, 근처 이웃에게 도움을 요청해보세요.<br/>

      독서모임, 산책모임 등 이웃과 함께하면 더 즐거운 활동을 이웃과 함께해보세요.

      공감과 댓글로 정보도 교환하고 따뜻한 이웃 공동체를 만들어보세요.<br/>
